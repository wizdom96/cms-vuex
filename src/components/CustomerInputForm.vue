  ...
  <div>
    <form @submit="submit($event)">
      <div class="field">
        ...
        <div class="control">
          <input class="input" v-model="customer.name" type="text" placeholder="Name" required />
        </div>
      </div>
      ...
      <div class="field">
        ...
        <select class="form-control" name="type" v-model="customer.priceRange">
          <option :value="type" v-for="type in data.types" :key="type">{{type}}</option>
        </select>
      </div>
      ...
      <div class="field">
        ...
        <select class="form-control" name="type" v-model="customer.priceRange">
          <option :value="price" v-for="price in data.prices" :key="price">{{price}}</option>
        </select>
      </div>
